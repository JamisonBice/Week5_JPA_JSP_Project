...
<small class="text-muted">Make changes to range,make,model or price.</small>
<br />
<form action = "editItemServlet" method="post">
<div class="form-group">
<label for="range">Range:</label><input type ="text" name = "range" value= "${itemToEdit.range}"><br />
...
<input type = "text" name = "price"  value= "${itemToEdit.price}"><br />
</div>
